<li class="treeview {{ Request::is('classes*') || Request::is('classrooms*') || Request::is('levels*') || Request::is('batches*') || Request::is('shifts*') || Request::is('courses*') || Request::is('faculties*') || Request::is('times*')  || Request::is('academics*') || Request::is('days*') || Request::is('semesters*') || Request::is('departments*') ? 'active' : ''  }}">
    <a href="#">
...
<li class="treeview {{ Request::is('classAssignings*') || Request::is('classSchedulings*')  ? 'active' : '' }}">
    <a href="#">
        <i class="fa fa-dashboard"></i>
        <span>Schedule</span>
        <span class="pull-right-container">
...
<li class="{{ Request::is('attendences*') ? 'active' : '' }}">
    <a href="{{ route('attendences.index') }}"><i class="fa fa-calendar"></i><span>Attendences</span></a>
</li>
 @if(Auth::user()->roler_id > 4)
